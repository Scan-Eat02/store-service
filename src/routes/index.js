...
router.put(`${serviceEndpointPrefix}/get-admin-stores`, (req, res) => storeController.getUserStoresAction(req, res));
router.put(`${serviceEndpointPrefix}/get-all-stores`, (req, res) => storeController.getAllStoresAction(req, res));
